 ...
 * @return bool
 */
function rmcr_categorized_blog() {
	if ( false === ( $all_the_cool_cats = get_transient( 'rmcr_categories' ) ) ) {
		...
		set_transient( 'rmcr_categories', $all_the_cool_cats );
	}

	if ( $all_the_cool_cats > 1 ) {
		// This blog has more than 1 category so rmcr_categorized_blog should return true.
		return true;
	} else {
		// This blog has only 1 category so rmcr_categorized_blog should return false.
		return false;
	}
}

/**
 * Flush out the transients used in rmcr_categorized_blog.
 */
function rmcr_category_transient_flusher() {
	// Like, beat it. Dig?
